...
public class areaperimetrovueltas {
    public static void main(String[] args) {
        double largo, ancho,perimetroCirculo,radioCirculo,areaCirculo,longitudRectangulo,perimetroTotal,areaRectangulo,areatotal,vueltas,MetrosExtra;
        ...
        System.out.printf("Para hacer una media maraton(21.097 metros) en este terreno hay que hacer un total de: %.0f y %.0f metros",vueltas,MetrosExtra);
    }
}
